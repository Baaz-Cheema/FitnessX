        ...
        <>
            <section className="py-20 relative h-[90vh] flex items-center overflow-hidden">
                ...
                <div className="max-w-[80rem] mx-auto flex  md:flex-col-reverse justify-between items-center">
                    ...
                    <motion.div onClick={() => setOpen(!open)} whileHover={{ scale: .9, transition: { delay: 0, duration: .2 } }} initial={{ y: 40, opacity: 0 }} viewport={{ once: true }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: .7, duration: .2 }}
