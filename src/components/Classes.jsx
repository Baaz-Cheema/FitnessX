...
export default function Classes() {
    return (
        <section className="bg-zinc-100 py-20 gym-bg relative">
            <div className="flex justify-center">
                <motion.h2 initial={{ scale: 2, opacity: 0 }} viewport={{ once: true }} whileInView={{ scale: 1, opacity: [0, .5, 1] }} transition={{ duration: .5 }}
                    className="text-zinc-950 text-center w-8/12 text-[3.3rem] sm:text-[2.3rem] xs:text-[1.9rem] uppercase font-montserrat font-extrabold leading-[3.5rem] sm:leading-[2.5rem] mb-5  lg:w-full">
            ...
            <div className="flex justify-around max-w-[80rem] mx-auto">
                <div className="grid grid-cols-4 grid-rows-2 gap-7 mx-5 lg:grid-cols-2 lg:grid-rows-4 md:grid-cols-1 md:grid-rows-6 classes">
                    <div className=" lg:h-auto col-span-2 md:col-span-1 relative overflow-hidden parent">
                        <div className="absolute item-1">
                        </div>
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] relative">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">Cycling</h2>
                            <p className="text-slate-50 bg-red-500 font-rajdhani px-2">Monday: 9am-10am </p>
                        </div>
                    </div>

                    <div className=" relative overflow-hidden parent">
                        ...
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] opacity-100 relative ">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">Martial Arts</h2>
                    ...
                    <div className="relative overflow-hidden parent">
                        ...
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] relative">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">HIIT</h2>
                    ...
                    <div className="relative overflow-hidden parent">
                        ...
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] relative">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">Yoga</h2>
                    ...
                    <div className="relative overflow-hidden parent">
                        ...
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] relative">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">Boxing</h2>
                            <p className="text-slate-50 bg-red-500 font-rajdhani px-2">Friday: 9am-10am </p>
                        </div>
                    </div>

                    <div className="col-span-2 relative overflow-hidden md:col-span-1 parent">
                        <div className="absolute item-6">
                        </div>
                        <div className="h-full flex items-start flex-col justify-end pb-[2rem] pl-[2rem] relative">
                            <h2 className="text-3xl font-bold font-raleway text-slate-50 pb-2">Power Lifting</h2>
