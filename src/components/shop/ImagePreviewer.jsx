    ...
    return (
        <motion.section initial={{ opacity: 0 }}
            ...
            <div className="py-10 flex justify-center h-full relative "
                ...
                <div className="absolute top-0 right-10 sm:right-4 text-[3rem] text-white cursor-pointer hover:scale-110 transition-transform z-[120]">
                    <i className='bx bx-x  z-[120]'></i>
                </div>
                <div onClick={(e) => e.stopPropagation()} className=" absolute xs:hidden w-full top-[40%] px-10 flex justify-between text-[4rem] text-gray-400 sm:text-white sm:z-[0]">
                ...
                <div className="w-full h-full flex flex-col sm:justify-center items-center gap-5">
                    <div onClick={(e) => e.stopPropagation()} className="overflow-hidden h-[90%] sm:h-[70%] sm:w-full bg-gray-100 sm:flex sm:items-center sm:justify-center">
                    ...
                    <div className="flex gap-3 h-[11.5%] w-11/12 self-center items-center justify-center sm:z-[10]">
                        <div onClick={(event) => {
                            ...
                            setIndex(0);
                        }} className={`group flex justify-center items-center overflow-hidden  h-full w-[5rem]`}>
