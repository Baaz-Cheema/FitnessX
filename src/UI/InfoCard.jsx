export default function InfoCard({ title, image, date, para }) {
    return (
        <div className={`flex-1 flex flex-col h-full font-montserrat ${para ? 'text-black' : 'text-slate-50'} items-start  lg:max-w-[500px] blog`} >
            ...
            <h3 className="text-2xl mt-5 mb-3 sm:mb-2 font-bold" >{title}</h3>
